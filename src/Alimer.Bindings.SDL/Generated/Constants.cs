...
public static partial class SDL
{
	...
	public static ReadOnlySpan<byte> SDL_PROPERTY_WINDOW_CREATE_ALWAYS_ON_TOP_BOOLEAN => "always-on-top"u8;
	public static ReadOnlySpan<byte> SDL_PROPERTY_WINDOW_CREATE_BORDERLESS_BOOLEAN => "borderless"u8;
	public static ReadOnlySpan<byte> SDL_PROPERTY_WINDOW_CREATE_FOCUSABLE_BOOLEAN => "focusable"u8;
	public static ReadOnlySpan<byte> SDL_PROPERTY_WINDOW_CREATE_FULLSCREEN_BOOLEAN => "fullscreen"u8;
	public static ReadOnlySpan<byte> SDL_PROPERTY_WINDOW_CREATE_HEIGHT_NUMBER => "height"u8;
	public static ReadOnlySpan<byte> SDL_PROPERTY_WINDOW_CREATE_HIDDEN_BOOLEAN => "hidden"u8;
	public static ReadOnlySpan<byte> SDL_PROPERTY_WINDOW_CREATE_HIGH_PIXEL_DENSITY_BOOLEAN => "high-pixel-density"u8;
	public static ReadOnlySpan<byte> SDL_PROPERTY_WINDOW_CREATE_MAXIMIZED_BOOLEAN => "maximized"u8;
	public static ReadOnlySpan<byte> SDL_PROPERTY_WINDOW_CREATE_MENU_BOOLEAN => "menu"u8;
	public static ReadOnlySpan<byte> SDL_PROPERTY_WINDOW_CREATE_METAL_BOOLEAN => "metal"u8;
	public static ReadOnlySpan<byte> SDL_PROPERTY_WINDOW_CREATE_MINIMIZED_BOOLEAN => "minimized"u8;
	public static ReadOnlySpan<byte> SDL_PROPERTY_WINDOW_CREATE_MOUSE_GRABBED_BOOLEAN => "mouse-grabbed"u8;
	public static ReadOnlySpan<byte> SDL_PROPERTY_WINDOW_CREATE_OPENGL_BOOLEAN => "opengl"u8;
	public static ReadOnlySpan<byte> SDL_PROPERTY_WINDOW_CREATE_PARENT_POINTER => "parent"u8;
	public static ReadOnlySpan<byte> SDL_PROPERTY_WINDOW_CREATE_RESIZABLE_BOOLEAN => "resizable"u8;
	public static ReadOnlySpan<byte> SDL_PROPERTY_WINDOW_CREATE_TITLE_STRING => "title"u8;
	public static ReadOnlySpan<byte> SDL_PROPERTY_WINDOW_CREATE_TRANSPARENT_BOOLEAN => "transparent"u8;
	public static ReadOnlySpan<byte> SDL_PROPERTY_WINDOW_CREATE_TOOLTIP_BOOLEAN => "tooltip"u8;
	public static ReadOnlySpan<byte> SDL_PROPERTY_WINDOW_CREATE_UTILITY_BOOLEAN => "utility"u8;
	public static ReadOnlySpan<byte> SDL_PROPERTY_WINDOW_CREATE_VULKAN_BOOLEAN => "vulkan"u8;
	public static ReadOnlySpan<byte> SDL_PROPERTY_WINDOW_CREATE_WIDTH_NUMBER => "width"u8;
	public static ReadOnlySpan<byte> SDL_PROPERTY_WINDOW_CREATE_X_NUMBER => "x"u8;
	...
	public static ReadOnlySpan<byte> SDL_PROPERTY_WINDOW_ANDROID_WINDOW_POINTER => "SDL.window.android.window"u8;
	public static ReadOnlySpan<byte> SDL_PROPERTY_WINDOW_ANDROID_SURFACE_POINTER => "SDL.window.android.surface"u8;
	public static ReadOnlySpan<byte> SDL_PROPERTY_WINDOW_UIKIT_WINDOW_POINTER => "SDL.window.uikit.window"u8;
	public static ReadOnlySpan<byte> SDL_PROPERTY_WINDOW_UIKIT_METAL_VIEW_TAG_NUMBER => "SDL.window.uikit.metal_view_tag"u8;
	public static ReadOnlySpan<byte> SDL_PROPERTY_WINDOW_KMSDRM_DEVICE_INDEX_NUMBER => "SDL.window.kmsdrm.dev_index"u8;
	public static ReadOnlySpan<byte> SDL_PROPERTY_WINDOW_KMSDRM_DRM_FD_NUMBER => "SDL.window.kmsdrm.drm_fd"u8;
	public static ReadOnlySpan<byte> SDL_PROPERTY_WINDOW_KMSDRM_GBM_DEVICE_POINTER => "SDL.window.kmsdrm.gbm_dev"u8;
	public static ReadOnlySpan<byte> SDL_PROPERTY_WINDOW_COCOA_WINDOW_POINTER => "SDL.window.cocoa.window"u8;
	public static ReadOnlySpan<byte> SDL_PROPERTY_WINDOW_COCOA_METAL_VIEW_TAG_NUMBER => "SDL.window.cocoa.metal_view_tag"u8;
	public static ReadOnlySpan<byte> SDL_PROPERTY_WINDOW_VIVANTE_DISPLAY_POINTER => "SDL.window.vivante.display"u8;
	public static ReadOnlySpan<byte> SDL_PROPERTY_WINDOW_VIVANTE_WINDOW_POINTER => "SDL.window.vivante.window"u8;
	public static ReadOnlySpan<byte> SDL_PROPERTY_WINDOW_VIVANTE_SURFACE_POINTER => "SDL.window.vivante.surface"u8;
	public static ReadOnlySpan<byte> SDL_PROPERTY_WINDOW_WINRT_WINDOW_POINTER => "SDL.window.winrt.window"u8;
	...
	public static ReadOnlySpan<byte> SDL_PROPERTY_WINDOW_WAYLAND_XDG_SURFACE_POINTER => "SDL.window.wayland.xdg_surface"u8;
	public static ReadOnlySpan<byte> SDL_PROPERTY_WINDOW_WAYLAND_XDG_TOPLEVEL_POINTER => "SDL.window.wayland.xdg_toplevel"u8;
	public static ReadOnlySpan<byte> SDL_PROPERTY_WINDOW_WAYLAND_XDG_POPUP_POINTER => "SDL.window.wayland.xdg_popup"u8;
	public static ReadOnlySpan<byte> SDL_PROPERTY_WINDOW_WAYLAND_XDG_POSITIONER_POINTER => "SDL.window.wayland.xdg_positioner"u8;
	public static ReadOnlySpan<byte> SDL_PROPERTY_WINDOW_X11_DISPLAY_POINTER => "SDL.window.x11.display"u8;
	public static ReadOnlySpan<byte> SDL_PROPERTY_WINDOW_X11_SCREEN_NUMBER => "SDL.window.x11.screen"u8;
	public static ReadOnlySpan<byte> SDL_PROPERTY_WINDOW_X11_WINDOW_NUMBER => "SDL.window.x11.window"u8;
	...
	public static ReadOnlySpan<byte> SDL_HINT_ALLOW_TOPMOST => "SDL_ALOW_TOPMOST"u8;
	...
	public static ReadOnlySpan<byte> SDL_HINT_GDK_TEXTINPUT_DEFAULT => "SDL_GDK_TEXTINPUT_DEFAULT"u8;
